import { ComponentProps, createEffect, JSX, mergeProps, onMount, children as useChilden } from "solid-js";
...
export const HakinaWebComponent = (props: {
  style?: string,
  children?: JSX.Element,
}): JSX.Element => {
  const c = useChilden(() => props.children)
  return (
    <>
      <style>
        {compositionStyleText}
